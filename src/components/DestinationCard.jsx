  ...
  return (
    <div className="group block">
      {isPakistan ? (
        ...
        <div
          className="relative h-80 sm:h-90 md:h-100 rounded-xl overflow-hidden transition-all duration-500 border border-white/5 cursor-not-allowed opacity-95"
          aria-disabled="true"
        >
          <img
            alt={name}
            loading="lazy"
            className="object-cover absolute h-full w-full inset-0 transition-transform duration-700 group-hover:scale-105 group-hover:blur-[2px]"
            src={image}
          />
          <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/30 to-transparent" />
